...
export default function Footer() {
  return (
    <footer className="mt-5">
      <section className="container d-flex align-items-center px-0 py-3">
      <h3 className="logo-txt m-0 border-end border-white p-3 ps-sm-0 pe-sm-5 py-sm-4"><b>Learning Toys World</b></h3>
